...
SQL_CREATE_REMEMBER_TABLE = """ CREATE TABLE IF NOT EXISTS remember (full_command TEXT PRIMARY KEY ,
                                count_seen INTEGER NOT NULL ,
                                last_used REAL NOT NULL ,
                                command_info TEXT,
                                directory_context_id INTEGER DEFAULT NULL,
                                FOREIGN KEY(directory_context_id) REFERENCES directories(id)); """

SQL_CREATE_DIR_TABLE = """  CREATE TABLE IF NOT EXISTS directories (
